...
@Mod(net.khai.create_lets_breaking_bad.Create_Lets_Breaking_Bad.MOD_ID)
public class Create_Lets_Breaking_Bad {
    ...
    @EventBusSubscriber(modid = net.khai.create_lets_breaking_bad.Create_Lets_Breaking_Bad.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
